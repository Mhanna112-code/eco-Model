...
def ranking_performance(score_dict, k):
    ...
    print(
        "\tPrecision@: {1:" + str(avgPrec[0]) + "; 5: " + str(avgPrec[4]) + "; 10: " + str(avgPrec[9]) + "; 20: " + str(
            avgPrec[19]) + "}")
    print("\tRecall@: {1:" + str(avgRecall[0]) + "; 5: " + str(avgRecall[4]) + "; 10: " + str(
        avgRecall[9]) + "; 20: " + str(avgRecall[19]) + "}")
    print("\tF1@: {1:" + str(F1[0]) + "; 5: " + str(F1[4]) + "; 10: " + str(F1[9]) + "; 20: " + str(F1[19]) + "}")
    print("\tNDCG@: {1:" + str(avgNDCG[0]) + "; 5: " + str(avgNDCG[4]) + "; 10: " + str(avgNDCG[9]) + "; 20: " + str(
        avgNDCG[19]) + "}")
